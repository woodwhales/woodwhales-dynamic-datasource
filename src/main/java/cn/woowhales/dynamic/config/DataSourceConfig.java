package cn.woowhales.dynamic.config;

import cn.woowhales.dynamic.enums.DataSourceEnum;
import cn.woowhales.dynamic.datasource.DynamicDataSource;
 ...
 */
@Configuration
@MapperScan("cn.woowhales.dynamic.biz.mapper")
public class DataSourceConfig {
    ...
    public DataSource dataSourceMaster() {
        ...
        hikariDataSource.setJdbcUrl("jdbc:mysql://localhost:3306/master?useUnicode=true&characterEncoding=utf-8&allowMultiQueries=true&autoReconnect=true&serverTimezone=GMT%2B8");
    ...
    public DataSource dataSourceSlave() {
        HikariDataSource hikariDataSource = new HikariDataSource();
        hikariDataSource.setJdbcUrl("jdbc:mysql://localhost:3306/slave?useUnicode=true&characterEncoding=utf-8&allowMultiQueries=true&autoReconnect=true&serverTimezone=GMT%2B8");
        hikariDataSource.setUsername("root");
        hikariDataSource.setPassword("root1234");
        hikariDataSource.setDriverClassName("com.mysql.cj.jdbc.Driver");
        return hikariDataSource;
